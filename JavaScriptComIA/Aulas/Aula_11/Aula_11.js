// Atividade 01
// Crie uma página HTML que contenha um botão com o texto "Clique Aqui". Ao clicar nesse botão, um alerta deve ser exibido com a mensagem: "Botão clicado!".

// Para isso, siga os passos:
// - Crie a estrutura básica da página HTML, incluindo um botão com o id="meuBotao".

// - No arquivo JavaScript (ou dentro de uma tag <script>), adicione um event listener ao botão para escutar o evento de clique.

// - Quando o botão for clicado, exiba um alerta com a mensagem "Botão clicado!".
...
// Passo a Passo:
// - Crie um botão e uma lista (<ul>) vazia no HTML.
...
// Atividade 04
// Passo a Passo
// - Crie uma área na página para capturar o movimento do mouse.
...
// - Use o evento submit para capturar os dados do formulário quando ele for enviado.
...
// Atividade 06
// Passo a Passo
// - Crie um link (<a>) que normalmente redirecionaria para outra página.
// - No JavaScript, use o evento click para capturar o clique no link.
