// Atividade 02
// Crie uma página HTML que contenha três parágrafos (<p>). Em seguida, use JavaScript para selecionar todos os parágrafos da página e altere o texto de cada parágrafo para "Texto alterado".

// Passos:
// - Crie a estrutura básica HTML com três elementos <p>.
...
// Passos:
// - Crie a estrutura básica HTML com três divs contendo a classe "box" e um parágrafo dentro de cada div.
...
// Crie uma estrutura HTML com:
// - Uma imagem com o id="minhaImagem".
// - Um link com o id="meuLink".
// - Um botão com o id="meuBotao".
...
// Crie uma estrutura HTML com:
// - Um botão com o id="adicionarParagrafo".
// - Um botão com o id="removerParagrafo".
// - Uma div vazia com o id="container" onde os parágrafos serão inseridos.

// Quando o botão "Adicionar Parágrafo" for clicado:
// - Use appendChild() para adicionar um novo parágrafo dentro da div.
